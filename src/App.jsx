...
import { MdWorkOutline } from "react-icons/md";
import { IoIosLaptop } from "react-icons/io";
import { FaBook, FaFileAlt, FaMarkdown } from "react-icons/fa"; // Added for documentation
...
function App() {
  ...
  const projects = [
    ...
    {
      title: "SHOPCO | Technical Documentation Project",
      desc: "Ecommerce Application with comprehensive technical documentation",
      tech: ["React", "Node.js", "PostgreSQL", "JWT", "Swagger"],
      category: "fullstack",
      features: ["User authentication", "E-commerce management", "API Documentation"],
      github: "https://github.com/sooryajith77/shopco",
      demo: "https://your-shopco-demo.vercel.app",
      documentation: "https://github.com/sooryajith77/shopco/blob/master/README.md",
      image: "/images/shopco.png",
  ...
  // Updated skills array with documentation skills added
  const skills = [
    ...
    // Documentation Skills - NEW ADDITIONS
    {
  ...
  const achievements = [
    {
      ...
      description: "Built a production-ready CRM with JWT authentication, role-based access, PostgreSQL, Sequelize, dashboard analytics, and deployment on Vercel & Render."
    },
    {
      title: "SHOPCO E-Commerce Platform",
      description: "Developed a responsive full-stack e-commerce platform with authentication, product management, shopping cart, wishlist, and REST APIs with comprehensive API documentation."
    },
    {
      title: "Full Stack Developer & Technical Writer",
      description: "Strong knowledge of React.js, Next.js, Node.js, Express.js, MongoDB, PostgreSQL, Git, REST API development, and technical documentation with Markdown ."
    },
  ...
  return (
    <div className="app">
      ...
      <section id="home" className="hero">
        <div className="hero-container row-layout">
          ...
          <div className="hero-right">
            <h1>Hi, I'm <span className="gradient-text">Sooryajith</span></h1>
            <h2>{typedRole}<span className="type-cursor">|</span></h2>
            <p>Passionate about building scalable web applications and creating clear technical documentation.</p>
            <div className="hero-buttons">
              <button className="btn-primary" onClick={() => document.getElementById("projects")?.scrollIntoView({ behavior: "smooth" })}>View Projects</button>
              <button className="btn-secondary" onClick={() => window.open("https://git.upcode.in/sooryajith2004", "_blank")}>GitHub</button>
            </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="education-icon"><IoIosLaptop /></div>
            ...
            <p className="education-cgpa">
              React.js • Node.js • Express.js • MongoDB • PostgreSQL • REST APIs • Technical Documentation
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="contact-grid">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="contact-icon"><MdWorkOutline /></div>
              <h3>Open to Work</h3>
              <p>Full Stack Developer</p>
              <button
                className="available-badge"
      ...
      <footer className="footer">
        <div className="container">
          <p>© 2026 Surya | Full Stack Developer & Technical Writer</p>
          <p className="footer-quote">"Code, Learn, Build, Document, Repeat"</p>
        </div>
      </footer>
